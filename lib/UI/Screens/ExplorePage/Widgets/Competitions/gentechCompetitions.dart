...
class GenTechCompetitions extends StatefulWidget {
  @override
  State<GenTechCompetitions> createState() => _GenTechCompetitionsState();
}

class _GenTechCompetitionsState extends State<GenTechCompetitions> {
