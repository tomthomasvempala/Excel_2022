...
class NonTechCompetitions extends StatefulWidget {
  @override
  State<NonTechCompetitions> createState() => _NonTechCompetitionsState();
}

class _NonTechCompetitionsState extends State<NonTechCompetitions> {
