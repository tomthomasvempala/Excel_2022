...
class TalksEvents extends StatefulWidget {
  @override
  State<TalksEvents> createState() => _TalksEventsState();
}

class _TalksEventsState extends State<TalksEvents> {
  StreamController<dynamic> estream;
  bool dataLoaded = false;
  List<Event> events =
      CompetitionsData.where((i) => i.category == "Talks").toList();
  fetchfromNet() async {
